            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try (Connection conn = conexion.conectar()) {
                    ...
                    if (conn != null) {
                        ...
                        String sql = "UPDATE redesdeapoyo SET TipoDeRelacion = ?, TiposDeApoyo = ?, NombreDeApoyo = ?, DireccionDeApollo = ?, TelefonoDeApollo = ?";
                               

                       
                        try (PreparedStatement pst = conn.prepareStatement(sql)) {
                            pst.setString(1, tipoDeRelacion);
                            pst.setString(2, tiposDeApoyo);
