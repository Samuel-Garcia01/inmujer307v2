...
public class Colonias extends JFrame {
		...
		public void mostrarDatos() {
			...
			String sql = "SELECT Colonia, COUNT(Colonia) AS total FROM datos GROUP BY Colonia";
		...
		public Colonias() {
			...
			btnGracicar.addMouseListener(new MouseAdapter() {
				...
				public void mouseEntered(MouseEvent e) {
					btnGracicar.setIcon(new ImageIcon(Colonias.class.getResource("/img/GraficarPastel2.png/")));
				}
				@Override
				public void mouseExited(MouseEvent e) {
					btnGracicar.setIcon(new ImageIcon(Colonias.class.getResource("/img/GraficarPastel1.png/")));
				}
			});
			btnGracicar.setIcon(new ImageIcon(Colonias.class.getResource("/img/GraficarPastel1.png")));
			...
			btnGracicar.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					datos.setValue("Colonia 1",dato1);
					datos.setValue("Colonia 2", dato2);
					datos.setValue("Colonia 3",dato3);
					datos.setValue("Colonia 4",dato4 );
					datos.setValue("Colonia 5", dato5);
					datos.setValue("Colonia 6",dato6);
					datos.setValue("Colonia 7", dato7);
					datos.setValue("Colonia 8", dato8);
					datos.setValue("Colonia 9", dato9);
					datos.setValue("Colonia 10", dato10);
					
					JFreeChart grafico_pastel=ChartFactory.createPieChart(
							"Colonias con mayor indice de Insidentes",
							datos,
							true,
							true,
							false
			...
			btnGracicar.setBounds(720, 515, 58, 51);
