...
public class Efectos_Fisicos extends JFrame {
	...
	public Efectos_Fisicos() {
		...
		btnRegresar.setBackground(new Color(186, 85, 211));
		btnRegresar.setFont(new Font("Arial", Font.BOLD, 12));
		btnRegresar.setBounds(74, 360, 133, 23);
		panel.add(btnRegresar);
		
		JLabel lblNewLabel_8 = new JLabel("");
		lblNewLabel_8.setIcon(new ImageIcon(Efectos_Fisicos.class.getResource("/img/inmujer.png")));
		...
		btnGraficar.setBounds(509, 528, 133, 23);
