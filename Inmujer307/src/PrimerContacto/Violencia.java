...
public class Violencia extends JFrame {
		...
		try {
			...
			if (rs.next()) {
				...
				if (rsTipos.next()) {
					...
					if (chckbxViolenciaAcosoHostigamiento.getText().equalsIgnoreCase(rsTipos.getString("primer_tipo"))
							|| chckbxViolenciaAcosoHostigamiento.getText()
									.equalsIgnoreCase(rsTipos.getString("segundo_tipo"))
							|| chckbxViolenciaAcosoHostigamiento.getText()
									.equalsIgnoreCase(rsTipos.getString("tercer_tipo"))
							|| chckbxViolenciaAcosoHostigamiento.getText()
									.equalsIgnoreCase(rsTipos.getString("cuarto_tipo"))
							|| chckbxViolenciaAcosoHostigamiento.getText()
									.equalsIgnoreCase(rsTipos.getString("quinto_tipo"))
							|| chckbxViolenciaAcosoHostigamiento.getText()
									.equalsIgnoreCase(rsTipos.getString("sexto_tipo"))
							|| chckbxViolenciaAcosoHostigamiento.getText()
									.equalsIgnoreCase(rsTipos.getString("septimo_tipo"))) {
				...
				String sqlModalidades = "SELECT TRIM(REPLACE(SUBSTRING_INDEX(Modalidades_de_violencia,',',1),', ','')) AS primer_modalidad, TRIM(REPLACE(SUBSTRING_INDEX(SUBSTRING_INDEX(Modalidades_de_violencia,',',2),',',-1),', ','')) AS segunda_modalidad, TRIM(REPLACE(SUBSTRING_INDEX(SUBSTRING_INDEX(Modalidades_de_violencia,',',3),',',-1),', ','')) AS tercer_modalidad, TRIM(REPLACE(SUBSTRING_INDEX(SUBSTRING_INDEX(Modalidades_de_violencia,',',4),',',-1),', ','')) AS cuarta_modalidad, TRIM(REPLACE(SUBSTRING_INDEX(SUBSTRING_INDEX(Modalidades_de_violencia,',',5),',',-1),', ','')) AS quinta_modalidad, TRIM(REPLACE(SUBSTRING_INDEX(SUBSTRING_INDEX(Modalidades_de_violencia,',',6),',',-1),', ','')) AS sexta_modalidad, TRIM(REPLACE(SUBSTRING_INDEX(SUBSTRING_INDEX(Modalidades_de_violencia,',',7),',',-1),', ','')) AS septima_modalidad FROM datos WHERE EXP = '"
						+ DatosGenerales.exp + "'";
				PreparedStatement pstModalidades = con.prepareStatement(sqlModalidades);
				ResultSet rsModalidades = pstModalidades.executeQuery();
				if (rsModalidades.next()) {
					if (chckbxFamilia.getText().equalsIgnoreCase(rsModalidades.getString("primer_modalidad"))
							|| chckbxFamilia.getText().equalsIgnoreCase(rsModalidades.getString("segunda_modalidad"))
							|| chckbxFamilia.getText().equalsIgnoreCase(rsModalidades.getString("tercer_modalidad"))
							|| chckbxFamilia.getText().equalsIgnoreCase(rsModalidades.getString("cuarta_modalidad"))
							|| chckbxFamilia.getText().equalsIgnoreCase(rsModalidades.getString("quinta_modalidad"))
							|| chckbxFamilia.getText().equalsIgnoreCase(rsModalidades.getString("sexta_modalidad"))
							|| chckbxFamilia.getText().equalsIgnoreCase(rsModalidades.getString("septima_modalidad"))) {
						chckbxFamilia.setSelected(true);
					}
					if (chckbxNoviazgo.getText().equalsIgnoreCase(rsModalidades.getString("primer_modalidad"))
							|| chckbxNoviazgo.getText().equalsIgnoreCase(rsModalidades.getString("segunda_modalidad"))
							|| chckbxNoviazgo.getText().equalsIgnoreCase(rsModalidades.getString("tercer_modalidad"))
							|| chckbxNoviazgo.getText().equalsIgnoreCase(rsModalidades.getString("cuarta_modalidad"))
							|| chckbxNoviazgo.getText().equalsIgnoreCase(rsModalidades.getString("quinta_modalidad"))
							|| chckbxNoviazgo.getText().equalsIgnoreCase(rsModalidades.getString("sexta_modalidad"))
							|| chckbxNoviazgo.getText()
									.equalsIgnoreCase(rsModalidades.getString("septima_modalidad"))) {
						chckbxNoviazgo.setSelected(true);
					}
					if (chckbxDocente.getText().equalsIgnoreCase(rsModalidades.getString("primer_modalidad"))
							|| chckbxDocente.getText().equalsIgnoreCase(rsModalidades.getString("segunda_modalidad"))
							|| chckbxDocente.getText().equalsIgnoreCase(rsModalidades.getString("tercer_modalidad"))
							|| chckbxDocente.getText().equalsIgnoreCase(rsModalidades.getString("cuarta_modalidad"))
							|| chckbxDocente.getText().equalsIgnoreCase(rsModalidades.getString("quinta_modalidad"))
							|| chckbxDocente.getText().equalsIgnoreCase(rsModalidades.getString("sexta_modalidad"))
							|| chckbxDocente.getText().equalsIgnoreCase(rsModalidades.getString("septima_modalidad"))) {
						chckbxDocente.setSelected(true);
					}
					if (chckbxComunitario.getText().equalsIgnoreCase(rsModalidades.getString("primer_modalidad"))
							|| chckbxComunitario.getText()
									.equalsIgnoreCase(rsModalidades.getString("segunda_modalidad"))
							|| chckbxComunitario.getText().equalsIgnoreCase(rsModalidades.getString("tercer_modalidad"))
							|| chckbxComunitario.getText().equalsIgnoreCase(rsModalidades.getString("cuarta_modalidad"))
							|| chckbxComunitario.getText().equalsIgnoreCase(rsModalidades.getString("quinta_modalidad"))
							|| chckbxComunitario.getText().equalsIgnoreCase(rsModalidades.getString("sexta_modalidad"))
							|| chckbxComunitario.getText()
									.equalsIgnoreCase(rsModalidades.getString("septima_modalidad"))) {
						chckbxComunitario.setSelected(true);
					}
					if (chckbxInstitucional.getText().equalsIgnoreCase(rsModalidades.getString("primer_modalidad"))
							|| chckbxInstitucional.getText()
									.equalsIgnoreCase(rsModalidades.getString("segunda_modalidad"))
							|| chckbxInstitucional.getText()
									.equalsIgnoreCase(rsModalidades.getString("tercer_modalidad"))
							|| chckbxInstitucional.getText()
									.equalsIgnoreCase(rsModalidades.getString("cuarta_modalidad"))
							|| chckbxInstitucional.getText()
									.equalsIgnoreCase(rsModalidades.getString("quinta_modalidad"))
							|| chckbxInstitucional.getText()
									.equalsIgnoreCase(rsModalidades.getString("sexta_modalidad"))
							|| chckbxInstitucional.getText()
									.equalsIgnoreCase(rsModalidades.getString("septima_modalidad"))) {
						chckbxInstitucional.setSelected(true);
					}
					if (chckbxLaboral.getText().equalsIgnoreCase(rsModalidades.getString("primer_modalidad"))
							|| chckbxLaboral.getText().equalsIgnoreCase(rsModalidades.getString("segunda_modalidad"))
							|| chckbxLaboral.getText().equalsIgnoreCase(rsModalidades.getString("tercer_modalidad"))
							|| chckbxLaboral.getText().equalsIgnoreCase(rsModalidades.getString("cuarta_modalidad"))
							|| chckbxLaboral.getText().equalsIgnoreCase(rsModalidades.getString("quinta_modalidad"))
							|| chckbxLaboral.getText().equalsIgnoreCase(rsModalidades.getString("sexta_modalidad"))
							|| chckbxLaboral.getText().equalsIgnoreCase(rsModalidades.getString("septima_modalidad"))) {
						chckbxLaboral.setSelected(true);
					}
					if (chckbxCibernetica.getText().equalsIgnoreCase(rsModalidades.getString("primer_modalidad"))
							|| chckbxCibernetica.getText()
									.equalsIgnoreCase(rsModalidades.getString("segunda_modalidad"))
							|| chckbxCibernetica.getText().equalsIgnoreCase(rsModalidades.getString("tercer_modalidad"))
							|| chckbxCibernetica.getText().equalsIgnoreCase(rsModalidades.getString("cuarta_modalidad"))
							|| chckbxCibernetica.getText().equalsIgnoreCase(rsModalidades.getString("quinta_modalidad"))
							|| chckbxCibernetica.getText().equalsIgnoreCase(rsModalidades.getString("sexta_modalidad"))
							|| chckbxCibernetica.getText()
									.equalsIgnoreCase(rsModalidades.getString("septima_modalidad"))) {
						chckbxCibernetica.setSelected(true);
					}
				}

				String sqlHc = "SELECT TRIM(REPLACE(SUBSTRING_INDEX(SUBSTRING_INDEX(Hechos_y_motivos_de_la_atencion, '\\n', 1), 'Lugar: ', -1), 'Lugar: ', '')) AS lugar_hechos, TRIM(REPLACE(SUBSTRING_INDEX(SUBSTRING_INDEX(Hechos_y_motivos_de_la_atencion, '\\n', 2), 'Fecha: ', -1), 'Fecha: ', '')) AS fecha_hechos, TRIM(REPLACE(SUBSTRING_INDEX(SUBSTRING_INDEX(Hechos_y_motivos_de_la_atencion, '\\n', 3), 'Hora: ', -1), 'Hora:', '')) AS hora_hechos FROM datos WHERE EXP = '"
						+ DatosGenerales.exp + "'";
	...
	public Violencia() {
		...
		btnGuardar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (!txtLugar.getText().isEmpty()) {
					hechosYMotivos += "Lugar: " + txtLugar.getText() + "\n";
				} else {
		...
		btnGuardar.setBounds(481, 579, 126, 23);
		...
		btnNewButton.setBounds(256, 579, 126, 23);
