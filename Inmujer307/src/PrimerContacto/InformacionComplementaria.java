...
public class InformacionComplementaria extends JFrame {
	...
	public InformacionComplementaria() {
		...
		btnFinalizar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (checAutorizo.isSelected()) {
					...
					JOptionPane.showMessageDialog(null, "Debe seleccionar una opción de autorización.", "Error",
		...
		lblNewLabel_4
				.setIcon(new ImageIcon(InformacionComplementaria.class.getResource("/img/butterfly_side_view_56.png")));
		lblNewLabel_4.setBounds(224, -14, 61, 69);
		contentPane.add(lblNewLabel_4);

		JLabel lblNewLabel_5 = new JLabel("");
		lblNewLabel_5
				.setIcon(new ImageIcon(InformacionComplementaria.class.getResource("/img/butterfly_side_espejo.png")));
