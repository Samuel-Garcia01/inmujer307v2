...
public class Efectosfisicos extends JFrame {
	...
	public void insertarDatosEfectos() {
		...
		for (int i = 0; i < 8; i++) {
			if (chkHerida.isSelected() && !condFisicos[0]) {
				...
				Fisicos += (i + 1) + ". " + chkAmputaciones.getText().toLowerCase() + "\n";
				condFisicos[2] = true;
	...
	public void insertarEfectos(String fs, String psq, String sx, String ecpm) {
		...
		String sql = "UPDATE datos SET Efectos_fisicos = '" + fs + "', Efectos_psicologicos = '" + psq
				+ "', Efectos_sexuales = '" + sx + "', Efectos_economicos_y_patrimoniales = '" + ecpm
				+ "' WHERE EXP = '" + DatosGenerales.exp + "'";
		...
		try {
			...
			if (rs.next()) {
				...
				if (rsFisicos.next()) {
					...
					if (chkAmputaciones.getText().equalsIgnoreCase(rsFisicos.getString("primer_efecto"))
							|| chkAmputaciones.getText().equalsIgnoreCase(rsFisicos.getString("segundo_efecto"))
							|| chkAmputaciones.getText().equalsIgnoreCase(rsFisicos.getString("tercer_efecto"))
							|| chkAmputaciones.getText().equalsIgnoreCase(rsFisicos.getString("cuarto_efecto"))
							|| chkAmputaciones.getText().equalsIgnoreCase(rsFisicos.getString("quinto_efecto"))
							|| chkAmputaciones.getText().equalsIgnoreCase(rsFisicos.getString("sexto_efecto"))
							|| chkAmputaciones.getText().equalsIgnoreCase(rsFisicos.getString("septimo_efecto"))
							|| chkAmputaciones.getText().equalsIgnoreCase(rsFisicos.getString("octavo_efecto"))) {
					...
					if (chkOtrosFisicos.getText().equalsIgnoreCase(rsFisicos.getString("primer_efecto"))
							|| chkOtrosFisicos.getText().equalsIgnoreCase(rsFisicos.getString("segundo_efecto"))
							|| chkOtrosFisicos.getText().equalsIgnoreCase(rsFisicos.getString("tercer_efecto"))
							|| chkOtrosFisicos.getText().equalsIgnoreCase(rsFisicos.getString("cuarto_efecto"))
							|| chkOtrosFisicos.getText().equalsIgnoreCase(rsFisicos.getString("quinto_efecto"))
							|| chkOtrosFisicos.getText().equalsIgnoreCase(rsFisicos.getString("sexto_efecto"))
							|| chkOtrosFisicos.getText().equalsIgnoreCase(rsFisicos.getString("septimo_efecto"))
							|| chkOtrosFisicos.getText().equalsIgnoreCase(rsFisicos.getString("octavo_efecto"))) {
				...
				if (rsPsicologicos.next()) {
					...
					if (chkAislamiento.getText().equalsIgnoreCase(rsPsicologicos.getString("primer_efecto"))
							|| chkAislamiento.getText().equalsIgnoreCase(rsPsicologicos.getString("segundo_efecto"))
							|| chkAislamiento.getText().equalsIgnoreCase(rsPsicologicos.getString("tercer_efecto"))
							|| chkAislamiento.getText().equalsIgnoreCase(rsPsicologicos.getString("cuarto_efecto"))
							|| chkAislamiento.getText().equalsIgnoreCase(rsPsicologicos.getString("quinto_efecto"))
							|| chkAislamiento.getText().equalsIgnoreCase(rsPsicologicos.getString("sexto_efecto"))
							|| chkAislamiento.getText().equalsIgnoreCase(rsPsicologicos.getString("septimo_efecto"))
							|| chkAislamiento.getText().equalsIgnoreCase(rsPsicologicos.getString("octavo_efecto"))
							|| chkAislamiento.getText().equalsIgnoreCase(rsPsicologicos.getString("noveno_efecto"))
							|| chkAislamiento.getText().equalsIgnoreCase(rsPsicologicos.getString("decimo_efecto"))) {
						chkAislamiento.setSelected(true);
					}
					if (chkIdeaSuicida.getText().equalsIgnoreCase(rsPsicologicos.getString("primer_efecto"))
							|| chkIdeaSuicida.getText().equalsIgnoreCase(rsPsicologicos.getString("segundo_efecto"))
							|| chkIdeaSuicida.getText().equalsIgnoreCase(rsPsicologicos.getString("tercer_efecto"))
							|| chkIdeaSuicida.getText().equalsIgnoreCase(rsPsicologicos.getString("cuarto_efecto"))
							|| chkIdeaSuicida.getText().equalsIgnoreCase(rsPsicologicos.getString("quinto_efecto"))
							|| chkIdeaSuicida.getText().equalsIgnoreCase(rsPsicologicos.getString("sexto_efecto"))
							|| chkIdeaSuicida.getText().equalsIgnoreCase(rsPsicologicos.getString("septimo_efecto"))
							|| chkIdeaSuicida.getText().equalsIgnoreCase(rsPsicologicos.getString("octavo_efecto"))
							|| chkIdeaSuicida.getText().equalsIgnoreCase(rsPsicologicos.getString("noveno_efecto"))
							|| chkIdeaSuicida.getText().equalsIgnoreCase(rsPsicologicos.getString("decimo_efecto"))) {
				...
				if (rsSexuales.next()) {
					...
					if (chkEmbarazo.getText().equalsIgnoreCase(rsSexuales.getString("primer_efecto"))
							|| chkEmbarazo.getText().equalsIgnoreCase(rsSexuales.getString("segundo_efecto"))
							|| chkEmbarazo.getText().equalsIgnoreCase(rsSexuales.getString("tercer_efecto"))
							|| chkEmbarazo.getText().equalsIgnoreCase(rsSexuales.getString("cuarto_efecto"))) {
				...
				if (rsPatrimoniales.next()) {
					if (chkDejoEstudiar.getText().equalsIgnoreCase(rsPatrimoniales.getString("primer_efecto"))
							|| chkDejoEstudiar.getText().equalsIgnoreCase(rsPatrimoniales.getString("segundo_efecto"))
							|| chkDejoEstudiar.getText().equalsIgnoreCase(rsPatrimoniales.getString("tercer_efecto"))
							|| chkDejoEstudiar.getText().equalsIgnoreCase(rsPatrimoniales.getString("cuarto_efecto"))
							|| chkDejoEstudiar.getText().equalsIgnoreCase(rsPatrimoniales.getString("quinto_efecto"))
							|| chkDejoEstudiar.getText().equalsIgnoreCase(rsPatrimoniales.getString("sexto_efecto"))
							|| chkDejoEstudiar.getText().equalsIgnoreCase(rsPatrimoniales.getString("septimo_efecto"))
							|| chkDejoEstudiar.getText().equalsIgnoreCase(rsPatrimoniales.getString("octavo_efecto"))) {
